...
export interface FLPCrowdSaleInterface extends utils.Interface {
  functions: {
    ...
    "drawBNB(uint256)": FunctionFragment;
  ...
  decodeFunctionResult(functionFragment: "drawBNB", data: BytesLike): Result;
  decodeFunctionResult(
    functionFragment: "getTokenAmountBNB",
    data: BytesLike
  ): Result;
  ...
  events: {
    ...
    "DrawBNB(address,uint256)": EventFragment;
  ...
  getEvent(nameOrSignatureOrTopic: "DrawBNB"): EventFragment;
...
export interface DrawBNBEventObject {
  buyer: string;
  amount: BigNumber;
}
export type DrawBNBEvent = TypedEvent<[string, BigNumber], DrawBNBEventObject>;

export type DrawBNBEventFilter = TypedEventFilter<DrawBNBEvent>;
...
export interface FLPCrowdSale extends BaseContract {
  ...
  filters: {
    ...
    "DrawBNB(address,uint256)"(buyer?: null, amount?: null): DrawBNBEventFilter;
    DrawBNB(buyer?: null, amount?: null): DrawBNBEventFilter;
