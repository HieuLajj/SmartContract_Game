...
contract FLPCrowdSale is Ownable {
    ...
    event DrawBNB(address buyer, uint256 amount);
    ...
    function drawBNB(uint256 USDTAmount) external {
        ...
        SafeERC20.safeTransferFrom(token, msg.sender, address(this) , USDTAmount);
        //SafeERC20.safeTransfer(token, msg.sender, USDTAmount);
        emit DrawBNB(msg.sender, amount);
    }
